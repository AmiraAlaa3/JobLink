...
<body>
    <nav class="navbar navbar-expand-lg navbar-ligth bg-ligth">
        <div class="container-fluid">
            <a class="navbar-brand fw-bold fs-3" style="color:rgb(0, 85, 217)" href="#">JobLink</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="{{ route('jobs.index') }}">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href={{ route('candidate_account') }}>Account</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href={{ route('candidate_applications') }}>Application</a>
                    </li>
